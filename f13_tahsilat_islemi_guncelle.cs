...
{
    public partial class f13_tahsilat_islemi_guncelle : Form
    {
        public f13_tahsilat_islemi_guncelle()
        {
            InitializeComponent();
        }
        ...
        private void f13_tahsilat_islemi_guncelle_Load(object sender, EventArgs e)
        {
